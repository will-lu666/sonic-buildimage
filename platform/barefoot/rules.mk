...
$(LIBSAIREDIS)_DEPENDS += $(BFN_SAI) $(BFN_WNC_PLATFORM) $(BFN_INGRASYS_PLATFORM) $(BFN_PLATFORM)#$(LIBSAITHRIFT_DEV_BFN)

# Runtime dependency on sai is set only for syncd
$(SYNCD)_RDEPENDS += $(BFN_SAI) $(BFN_WNC_PLATFORM) $(BFN_INGRASYS_PLATFORM) $(BFN_PLATFORM)
